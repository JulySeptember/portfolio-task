...
func DecodeCreateUser(r *http.Request) (*models.User, int, error) {
...
func MergeUpdateUser(r *http.Request, existing *models.User) (int, error) {
...
func NewUserHandler(svc *service.UserService) *BaseHandler[models.User] {
        return NewBaseHandlerWithDTO[models.User](svc, DecodeCreateUser, MergeUpdateUser)
}
